...
public class OfferCard extends AnchorPane {
    Product product;
    ...
    @FXML Label newPriceLabel;
    @FXML Label productAmountLabel;
    @FXML AnchorPane productImageAnchorPane;
    @FXML ImageView favoriteIcon;

    public OfferCard(Product product, double loweredPrice, IMatController parentController) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("offer-card.fxml"));
        ...
        this.productPriceLabel.setText(product.getPrice() + "kr/" + product.getUnitSuffix());
        this.newPriceLabel.setText(loweredPrice + "kr/" + product.getUnitSuffix());
